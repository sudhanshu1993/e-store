...
<head>
        <meta charset="utf-8">
        <title>About Us - Digi Infotech - Computer / Laptop Shop</title>
                            ...
                            <nav class="navbar navbar-light navbar-expand-lg mainmenu col-lg-9 col-12">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="dropdown">
                                            <a class="dropdown-toggle" href="index.php" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">SERVICES</a>
                ...
                <div class="row margin-top-32">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="counter-block-1 text-center">
                            ...
                            <p class="text-uppercase">Trained Experts</p>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="counter-block-1 text-center">
                            ...
                            <p class="text-uppercase">Current Fixings</p>
            ...
            <div class="container">
                ...
                <div class="row section-heading-wrapper section-heading-wrapper-alt">
                    ...
                    <div class="col-md-12 col-sm-12 text-center">
                        <h4 class="heading-alt-style text-capitalize text-light-color">How It Works?</h4>
                ...
                <div class="row wow fadeInUp text-center">
                    ...
                    <div class="col-sm-12 text-center">
                        <a href="#" class="btn btn-theme margin-top-24 btn-square btn-invert">Book An Appointment</a>
                    </div>
        ...
        <section class="section-content-block section-secondary-bg" >
            ...
            <div class="container">
                ...
                <div class="row section-heading-wrapper">
                    ...
                    <div class="col-md-12 col-sm-12 text-center">
                        <h4 class="heading-alt-style text-capitalize text-dark-color">our repair experts</h4>
                        <span class="heading-separator heading-separator-horizontal"></span>
                        <h2 class="subheading-alt-style">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit curabitur eu ante non ex lobortis posuere 
                            <br />
                        ...
                        <div class="team-layout-1 text-center">       
                            ...
                            <figure class="team-member">
                                <a href="#" title="ALEXANDER GARY">
                                    <img src="images/team_2.jpg" alt="ALEXANDER GARY" />
                                </a>
                            </figure> <!-- end. team-member  -->
