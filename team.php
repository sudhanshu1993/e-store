...
<head>
        <meta charset="utf-8">
        <title>Our Experts - DigiInfotech - Computer / Laptop Shop</title>
    ...
    <body> 
        ...
        <!--  START TESTIMONIAL LAYOUT 01 -->

        <section class="section-content-block section-pure-black-bg">
