...
<head>
        <meta charset="utf-8">
        <title> DigiInfotech - Computer/ Laptop Shop</title>
    ...
    <body> 
        ...
        <section class="section-content-block section-gallery-bg" id="gallery-1">
            ...
            <div class="container">
                ...
                <div class="row section-heading-wrapper">
                    ...
                    <div class="col-md-12 col-sm-12 text-center">
                        <h4 class="heading-alt-style text-capitalize text-dark-color">Our Workshop</h4>
                ...
                <div class="row wow fadeInUp">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 gallery-container">
                        ...
                        <a class="gallery-light-box" data-gall="myGallery" href="images/gallery_7.jpg">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 gallery-container">
                        ...
                        <a class="gallery-light-box"  data-gall="myGallery" href="images/gallery_8.jpg">
        ...
        <section class="section-content-block">
            ...
            <div class="container">
                 ...
                 <div class="row section-heading-wrapper">
                    ...
                    <div class="col-md-12 col-sm-12 text-center">
                        <h4 class="heading-alt-style text-capitalize text-dark-color">Get Updates</h4>
                        <span class="heading-separator heading-separator-horizontal"></span>
                        <h2 class="subheading-alt-style">
