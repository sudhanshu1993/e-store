...
<head>
        <meta charset="utf-8">
        <title>Appointment - Digi Infotech - Computer/ Laptop Shop</title>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12 col-sm-12 col-xs-12 text-left">
                                            <button id="btn_submit" class="btn btn-lg btn-theme btn-square btn-theme-invert" type="submit">Get Appointment</button>
                                        </div>
            ...
            <div class="container">
                <div class="row section-heading-wrapper section-heading-wrapper-alt">
                    ...
                    <div class="col-12 col-sm-12 text-center">
                        <h4 class="heading-alt-style text-capitalize">Buyers Opinion</h4>
            ...
            <div class="container">
                ...
                <div class="row section-heading-wrapper">
                    ...
                    <div class="col-md-12 col-sm-12 text-center">
                        <h4 class="heading-alt-style text-capitalize text-dark-color">Available Services</h4>
                        <span class="heading-separator heading-separator-horizontal"></span>
                        <h2 class="subheading-alt-style">
