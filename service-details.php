...
<head>
        <meta charset="utf-8">
        <title> Service Detail- Digi Infotech - Computer / Laptop Shop</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <meta name="description" content="Digi Infotech - Computer Repair Store HTML5 Template">
    ...
    <body> 
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                                ...
                                <div class="top-bar-link">
                                    <strong>Support</strong> : +91 9454345464, +91 9331714298
                                </div>
                            ...
                            <div class="col-md-8 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12 clearfix">
                                        <a class="btn btn-theme btn-square btn-header-cta margin-top-36 float-right" href="appointment.php" title="GET FREE QUOTE">BOOK APPOINTMENT</a>   
                                    </div><!-- end .col-md-4  -->   
                                    ...
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="service.php">SERVICE LISTS</a></li>
                                                <li><a href="service-details.php">SINGLE SERVICE</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="team.php" title="About Us">Our Team</a></li>
                                        <li><a href="gallery.php" title="About Us">Gallery</a></li>
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="drop">
                                                    ...
                                                    <ul class="drop-down level3">
                                                        <li><a href="team.php">TEAM LISTS</a></li> 
                                                ...
                                                <li class="drop">
                                                    ...
                                                    <ul class="drop-down level3">
                                                        ...
                                                        <li><a href="gallery-3.php">LAYOUT 03</a></li>
                                                    </ul>
                                                </li>
                                        ...
                                        <!-- <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="element-counter.php" title="Counter">COUNTER</a></li>
                                                <li><a href="element-cta.php" title="CTA">CTA BOX</a></li>
                                                <li><a href="element-testimonial.php" title="Testimonial">TESTIMONIAL</a></li>  
                                                <li><a href="element-highlights.php" title="Highlights">HIGHLIGHTS</a></li>
                                                <li><a href="element-info-box.php" title="Infobox">INFO BOX</a></li>  
                                                <li><a href="element-logos.php" title="Logos">LOGOS</a></li>  
                                                <li><a href="element-pricing-table.php" title="Pricing">PRICING TABLE</a></li>  
                                                <li><a href="element-process.php" title="Process">PROCESS</a></li> 
                                                <li><a href="element-service.php" title="Service">SERVICE</a></li>   
                                                <li><a href="element-appointment.php" title="Appointment Form">APPOINTMENT FORM</a></li>   
                                                <li><a href="element-subscribe.php" title="Subscribe">SUBSCRIBE</a></li>   
                                                <li><a href="element-team.php" title="Teams">TEAMS</a></li>   
                                            </ul>
                                        </li> -->
                                        <li><a href="faq.php" title="Contact">FAQ</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">   
                                ...
                                <div class="single-service-content">  
                                    ...
                                    <h2 class="block-heading-title text-capitalize">How to Keep Your Motherboard Clean?</h2>

                                    <p>
                                        The recommended pressure to inflate a tyre to is usually embossed on the tyre's sidewall, often as minimum and maximum figures rather than an exact target. 
                                        There are a number of factors to consider when deciding how hard your tyres need to be fixed.                      
                                    </p>  

                                    <p>
                                        The hose or pump connection may screw on or press on. Some push fit connections lock with a cam lever. 
                                        To check the correct operation of the connection look at the rubber washer and move the lever back and forth. 
                                        The the 'locked' position squeezes the washer, the 'on-off' position lets the washer relax.
                                    </p>
                                    
                                    <h3 class="block-heading-title text-capitalize">Get Your Motherboard Repaired With In Two Days</h3>

                                    <p>
                                        We often had to replace the tires two or three times a month, and naturally we would have a load in the back when we got the flat. 
                                        That meant unloading the truck, changing the tire, reloading it and then carrying on with the day’s work. Man, it took longer to unload and reload that truck than it did to change the darn tire.
                                    </p>

                                    <ul>
                                        <li> Pulsation or vibrations in the brake pedal.</li>
                                        <li> Feel your brake pedal and steering wheel.</li>
                                        <li> Longer stopping distances ever back and forth.</li>
                                        <li> Reload that truck than it did to change.</li>
                                        <li> Position squeezes the washer relax.</li>
                                    </ul>  
                    ...
                    <div class="col-lg-4 col-12">        
                        ...
                        <div class="widget site-sidebar">
                            ...
                            <ul class="widget-service-category clearfix">
                                <li>
                                    <a title="service details" href="#">Laptop Repair </a>
                                </li>
                                <li>
                                    <a title="service details" href="#">Motherboard Repair </a>
                                </li>
                                <li>
                                    <a title="service details" href="#">Display Repair </a>
                                </li>
                                <li>
                                    <a title="service details" href="#">Processor Repair</a>
                                </li>
                                <li>
                                    <a title="service details" href="#">Battery Replacement</a>
                                </li>
                                <li>
                                    <a title="service details" href="#">Virus Removal</a>
                                </li>
                            </ul>
                        ...
                        <div class="widget site-sidebar">
                            ...
                            <div class="text-widget">
                                Smart Fix offers professional laptop repair services at our retail locations throughout world. 
                                The high level of customer service has allowed to open multiple full-service repair centers.
                                <p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h2 class="text-capitalize">one stop computer repair service </h2>
                        <p>
                        ...
                        <a class="btn btn-theme btn-theme-invert margin-top-12" href="#">Book Appointment</a>
                    </div> <!--  end .col-md-8  -->
                </div> <!--  end .row  -->
            </div>
        </section>
        ...
        <footer class="section-custom-bg" data-bg_img="images/footer_custom_bg.jpg" data-bg_opacity=".9" data-bg_color="#edf0f2" data-bg_position="center bottom">            
                                ...
                                <div class="sidebar-widget-wrapper">
                                    ...
                                    <div class="textwidget about-footer"> 
                                        ...
                                        <div class="footer-about-text">
                                            <a href="#">
                                                <img src="images/logo.png" alt="" class="footer-logo img-responsive">
                                            </a>
                            ...
                            <div class="footer-widget text-dark-color">
                                ...
                                <div class="sidebar-widget-wrapper">
                                    ...
                                    <div class="footer-widget-header clearfix">
                                        <h3 class="text-dark-color">OPENING HOURS</h3>
                            ...
                            <div class="footer-widget text-dark-color">
                                ...
                                <div class="sidebar-widget-wrapper">
                                    ...
                                    <div class="textwidget">
                                        ...
                                        <i class="fa fa-location-arrow fa-contact"></i> <p class="text-dark-color">Shop No. 9, UGF, Sakeena Plaza, Lucknow</p>

                                        <i class="fa fa-phone fa-contact"></i> <p class="text-dark-color">Office:&nbsp; (+91) 9454345464<br/>Cell:&nbsp; (+91) 6392729291</p>                              
                                        
                                        <i class="fa fa-envelope-o fa-contact"></i> <p class="text-dark-color"><a href="#">digiinfotec12@gmail.com</a><br/><a href="#"></a></p>
                ...
                <div class="container">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 clearfix text-center  border-top-1-dark">
                            <p class="copyright-text text-dark-color pt-4"> Copyright © 2015-2020. All Right Reserved -  Design & Developed by Yashaswi Bhawa Pvt. Ltd. </p>
                        </div>
